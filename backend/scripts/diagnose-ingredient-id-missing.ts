...
const DSLD_EXCLUDED_KEY_PATTERNS: RegExp[] = [
  ...
  /\bvasodilation amplifier\b/,
  /\bbuffering system\b/,
  /\bcell signalling amplifier\b/,
  /\bcellular transport amplifier\b/,
  /\bcell volumizer\b/,
  /\banabolic peptide x\b/,
  /\butilization enzymes?\b/,
  /\bstimulators?\b/,
  /\bprocess glands?\b/,
  /\bother carbohydrates\b/,
  /\b(?:total|trans)\s+fat\b.*\bnone\b/,
  /\btotal carbohydrates?\s+0\b/,
  /\bsugar(?:s)?\s+0\b.*\bnone\b/,
  /\bsugars alcohols\b/,
];
