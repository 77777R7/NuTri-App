...
const patchPath = "output/runs/20260128_dsld_phaseD_run1/identity_sprint/identity_top120_import_patch_v3.json";
const outPath = "output/runs/20260128_dsld_phaseD_run1/identity_sprint/rebackfill_ids_5kA5kB_v2.json";

const patch = JSON.parse(readFileSync(patchPath, "utf8"));
const synonyms: string[] = [];
for (const ing of patch.ingredients ?? []) {
  synonyms.push(ing.ingredient);
