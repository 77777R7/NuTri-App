...
export const SCAN_SIDECAR_POLICIES: Record<
  ScanSidecarRoute,
  ScanSidecarPolicy
> = {
  decision_support: {
...
export const getScanSidecarPolicy = (
  route: ScanSidecarRoute,
): ScanSidecarPolicy => SCAN_SIDECAR_POLICIES[route];
...
export const buildScanSidecarCacheKey = (params: {
  ...
  const selectedIngredientKey = normalizePart(
