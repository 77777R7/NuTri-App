...
export const DEFAULT_FULL_STREAM_MAX_ACTIVE = 4;
...
export const DEFAULT_FULL_STREAM_QUEUE_WAIT_MS = 1500;
export const DEFAULT_BUNDLE_ONLY_STREAM_QUEUE_WAIT_MS = 1500;
export const DEFAULT_STREAM_OVERLOAD_INFLIGHT_THRESHOLD = 6;
