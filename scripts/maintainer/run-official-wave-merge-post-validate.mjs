...
const DYNAMIC_TITLE_ANCHOR_RULES = [
  { pattern: /\bperfect\s*amino\b/i, anchors: ["PerfectAmino Amino Acid Blend", "Perfect Amino EAA & NA Proprietary Blend", "Amino Acid Blend"] },
  ...
  { pattern: /\bb12\s+energy\b/i, anchors: ["B12 Energy", "Vitamin B12", "Methylcobalamin"] },
  { pattern: /\b(?:b[\s-]*complex|methyl\s*b12)\b|\bvitamin\s*b\+(?=\s|,|$)/i, anchors: ["B-Complex", "Vitamin B Complex", "Methyl B12"] },
  ...
  { pattern: /\btart\s+cherr(?:y|ies)\b/i, anchors: ["Tart Cherry"] },
  { pattern: /\bquercetin\b/i, anchors: ["Quercetin", "D.r.-Quercetin"] },
  { pattern: /\bgreen\s+guard\b/i, anchors: ["Greens", "Broccoli"] },
  { pattern: /\btea\s+bags?\b|\bherbal\s+tea\b/i, anchors: ["Tea blend", "Tea"] },
  ...
  { pattern: /\bliving\s+calcium\b/i, anchors: ["Calcium (from Algae)", "Calcium", "Living Calcium"] },
  ...
  { pattern: /\bmulti[\s-]*minerals?\b|\bmultimineral\b/i, anchors: ["Multivitamin & Mineral Formula", "Multi Mineral"] },
  ...
  { pattern: /\bjoint\s+support\b|\bno\.?\s*7\b|\bh\.?\s*a\.?\b.*\bjoint\b|\bjoint\b.*\bskin\b/i, anchors: ["Joint Support Complex", "Collagen", "Hyaluronic Acid"] },
  ...
  { pattern: /\bcod\s+liver\s+oil\b|\bfish\s+oil\b/i, anchors: ["Cod Liver Oil", "Fish Oil", "Omega-3", "DHA", "EPA"] },
  ...
  { pattern: /\b(?:nascent\s+)?iodine\b|\bdetoxadine\b/i, anchors: ["Iodine", "Nascent Iodine"] },
  ...
  { pattern: /\b(?:earth\s+)?broth\b/i, anchors: ["Herbal Broth Blend", "Earth Broth", "Greens"] },
