...
const en = {
    ...
    checkInEmptyTitle: 'Save your first scan',
    checkInEmptyDescription: 'Scan a supplement, then save it to your stack for Daily Check-in.',
    ...
    analysisSectionNutriScoreTitle: 'NuTri Score',
    analysisSectionNutriScoreSubtitle: 'Tap to view detailed analysis',
    analysisSectionDeepDiveTitle: 'Deep Dive',
    analysisSectionDeepDiveSubtitle: 'Tap to view detailed analysis',
    analysisSectionComparisonTitle: 'Comparison with similar products',
    analysisSectionComparisonSubtitle: 'See how this product stands and explore higher-scoring options',
    analysisComparisonAlternativesTitle: 'Higher-scoring alternatives',
    analysisComparisonScoreLabel: 'NuTri Score',
    analysisComparisonNotEnoughPeers: 'Not enough comparable products yet',
    analysisComparisonAlreadyScoresWell: 'This product already scores well among comparable options.',
    analysisSectionPersonalInsightTitle: 'Personal insight',
