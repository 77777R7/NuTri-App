...
exports.isPersonalizationReasonCode = exports.mergeDecisionReasons = exports.dedupeReasons = exports.dedupeDecisionReasons = exports.getDecisionReasonKey = exports.cloneReason = exports.createCatalogReason = exports.createDerivedReason = exports.createObservedReason = exports.createDeclaredReason = exports.createScopedReason = exports.buildReason = exports.createDecisionReason = exports.buildReasonCode = exports.buildRuleId = exports.REASON_CODES = exports.RULE_IDS = exports.DEFAULT_PERSONALIZATION_COMPUTED_AT = exports.PERSONALIZATION_RULES_VERSION = exports.PERSONALIZATION_PROFILE_VERSION = void 0;
exports.PERSONALIZATION_PROFILE_VERSION = 'personalization-profile/v1-phase1';
exports.PERSONALIZATION_RULES_VERSION = 'personalization-rules/v1-phase7';
exports.DEFAULT_PERSONALIZATION_COMPUTED_AT = '1970-01-01T00:00:00.000Z';
...
const buildRuleId = (...segments) => ['personalization', ...segments].join('.');
exports.buildRuleId = buildRuleId;
const buildReasonCode = (...segments) => ['personalization', ...segments].join('.');
exports.buildReasonCode = buildReasonCode;
const createDecisionReason = (input) => {
...
exports.createDecisionReason = createDecisionReason;
const buildReason = (code, ruleId, source, params) => (0, exports.createDecisionReason)({
    code,
    ruleId,
    source,
    params,
});
exports.buildReason = buildReason;
const createScopedReason = (scope, key, source, params) => {
    ...
    return (0, exports.createDecisionReason)({
        code,
        ruleId,
        source,
        params,
...
exports.createScopedReason = createScopedReason;
const createScopedDecisionReason = (source) => (input) => (0, exports.createDecisionReason)({
    ...input,
    source,
});
exports.createDeclaredReason = createScopedDecisionReason('declared');
exports.createObservedReason = createScopedDecisionReason('observed');
exports.createDerivedReason = createScopedDecisionReason('derived');
exports.createCatalogReason = createScopedDecisionReason('catalog');
const cloneReason = (reason) => (0, exports.createDecisionReason)({
    code: reason.code,
    ruleId: reason.ruleId,
    source: reason.source,
    params: reason.params,
});
exports.cloneReason = cloneReason;
const getDecisionReasonKey = (reason) => JSON.stringify([
    reason.ruleId,
    reason.code,
    reason.source,
    reason.params ? Object.entries(sortParams(reason.params) ?? {}) : [],
]);
exports.getDecisionReasonKey = getDecisionReasonKey;
const dedupeDecisionReasons = (reasons) => {
    const seen = new Set();
    const deduped = [];
    reasons.forEach((reason) => {
        const normalized = (0, exports.cloneReason)(reason);
        const key = (0, exports.getDecisionReasonKey)(normalized);
        if (seen.has(key))
            return;
        seen.add(key);
...
exports.dedupeDecisionReasons = dedupeDecisionReasons;
const dedupeReasons = (...collections) => (0, exports.dedupeDecisionReasons)(collections.flatMap((collection) => collection ?? []));
exports.dedupeReasons = dedupeReasons;
const mergeDecisionReasons = (...collections) => (0, exports.dedupeReasons)(...collections);
exports.mergeDecisionReasons = mergeDecisionReasons;
const isPersonalizationReasonCode = (value) => Object.values(exports.REASON_CODES).some((entry) => typeof entry === 'string' && entry === value);
exports.isPersonalizationReasonCode = isPersonalizationReasonCode;
