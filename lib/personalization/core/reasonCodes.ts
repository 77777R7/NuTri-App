...
const EVALUATION_RULE_IDS = {
  ...
  productOutOfScopeNonSupplement: 'personalization.evaluation.coverage_gate',
...
const EVALUATION_REASON_CODES = {
  ...
  productOutOfScopeNonSupplement: 'personalization.product_evaluation.out_of_scope_non_supplement',
...
export const REASON_CODES = {
  ...
  productOutOfScopeNonSupplement: EVALUATION_REASON_CODES.productOutOfScopeNonSupplement,
